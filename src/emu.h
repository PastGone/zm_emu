 ...
 *   2) 入口 stub（文件偏移 0x188）经 ROOT_TABLE_ADDR 槽写入的 handler = 0x11108C，
 ...
 *
 * ROOT_TABLE_ADDR[0x154] create_cbk 返回 CBK_OBJ；applet 随后把 **CBK_OBJ+0x48**
...
#define TR_util_x00 TRAP(IUTIL_VT_ADDR + 0x00U)
#define TR_util_x04 TRAP(IUTIL_VT_ADDR + 0x04U)
#define TR_util_x08 TRAP(IUTIL_VT_ADDR + 0x08U)
#define TR_util_x0C TRAP(IUTIL_VT_ADDR + 0x0CU)
#define TR_util_x10 TRAP(IUTIL_VT_ADDR + 0x10U)
#define TR_util_x14 TRAP(IUTIL_VT_ADDR + 0x14U)
#define TR_util_x18 TRAP(IUTIL_VT_ADDR + 0x18U)
...
// root
enum ZM_ROOT_TABLE {
 ZM_GetShell = ROOT_TABLE_ADDR+0x00U,
};

#define TR_root_getShell TRAP(ROOT_TABLE_ADDR + 0x00U)
#define TR_root_malloc TRAP(ROOT_TABLE_ADDR + 0x08U)
#define TR_root_free TRAP(ROOT_TABLE_ADDR + 0x0cU)
#define TR_root_str_copy TRAP(ROOT_TABLE_ADDR + 0x20U)
#define TR_root_sprintf TRAP(ROOT_TABLE_ADDR + 0x6cU)
#define TR_root_str_ctor TRAP(ROOT_TABLE_ADDR + 0x88U)
#define TR_root_spec_lookup TRAP(ROOT_TABLE_ADDR + 0xa4U)
...
#define TR_root_strstr TRAP(ROOT_TABLE_ADDR + 0xb0U)
#define TR_root_str_find TRAP(ROOT_TABLE_ADDR + 0xa8U)
// runtime
/*
...
#define TR_shell_AddRef TRAP(SHELL_VT_ADDR + 0x00U)
#define TR_shell_Release TRAP(SHELL_VT_ADDR + 0x04U)
#define TR_shell_CreateInstance TRAP(SHELL_VT_ADDR + 0x08U)
#define TR_shell_x0C TRAP(SHELL_VT_ADDR + 0x0CU) /* RE sub_34DE4，未知 */
#define TR_shell_GetDeviceInfo TRAP(SHELL_VT_ADDR + 0x10U)
#define TR_shell_GetRootDir TRAP(SHELL_VT_ADDR + 0x14U)
#define TR_shell_SetWorkDir TRAP(SHELL_VT_ADDR + 0x18U)
#define TR_shell_GetWorkDir TRAP(SHELL_VT_ADDR + 0x1CU)
#define TR_shell_StartApplet TRAP(SHELL_VT_ADDR + 0x20U)
#define TR_shell_x24 TRAP(SHELL_VT_ADDR + 0x24U) /* RE sub_3482C，未知 */
#define TR_shell_CanStartApplet TRAP(SHELL_VT_ADDR + 0x28U)
#define TR_shell_ActiveApplet TRAP(SHELL_VT_ADDR + 0x2CU)
#define TR_shell_GetApplet TRAP(SHELL_VT_ADDR + 0x30U)
#define TR_shell_x34 TRAP(SHELL_VT_ADDR + 0x34U) /* RE sub_34764，未知 */
#define TR_shell_x38 TRAP(SHELL_VT_ADDR + 0x38U) /* RE sub_34C1C，未知 */
#define TR_shell_SetTimer TRAP(SHELL_VT_ADDR + 0x3CU)
#define TR_shell_CancelTimer TRAP(SHELL_VT_ADDR + 0x40U)
#define TR_shell_CancelOwnerTimer TRAP(SHELL_VT_ADDR + 0x44U)
#define TR_shell_GetTickCount TRAP(SHELL_VT_ADDR + 0x48U)
#define TR_shell_OpenWapBrowser TRAP(SHELL_VT_ADDR + 0x4CU)
#define TR_shell_x50 TRAP(SHELL_VT_ADDR + 0x50U) /* RE sub_3474C，未知 */
#define TR_shell_SetEndKeyMask TRAP(SHELL_VT_ADDR + 0x54U)
#define TR_shell_LoadDLL TRAP(SHELL_VT_ADDR + 0x58U)
#define TR_shell_UnloadDLL TRAP(SHELL_VT_ADDR + 0x5CU)
#define TR_shell_GetAppletMask TRAP(SHELL_VT_ADDR + 0x60U)
#define TR_shell_SetAppletMask TRAP(SHELL_VT_ADDR + 0x64U)
#define TR_shell_IsLoadGlobalLibrary TRAP(SHELL_VT_ADDR + 0x68U)
#define TR_shell_LoadGlobalLibrary TRAP(SHELL_VT_ADDR + 0x6CU)
#define TR_shell_FreeGlobalLibrary TRAP(SHELL_VT_ADDR + 0x70U)
#define TR_shell_IsGlobalLibraryUseStaticMem TRAP(SHELL_VT_ADDR + 0x74U)
#define TR_shell_LoadLibraryExt TRAP(SHELL_VT_ADDR + 0x78U)
#define TR_shell_EntryApplet TRAP(SHELL_VT_ADDR + 0x7CU)
#define TR_shell_GetAppDir TRAP(SHELL_VT_ADDR + 0x80U)
#define TR_shell_GetSupportHall TRAP(SHELL_VT_ADDR + 0x84U)
// fs
/*
...
#define TR_fileMgr_AddRef TRAP(FileMgr_VT_ADDR + 0x00U)
#define TR_fileMgr_Release TRAP(FileMgr_VT_ADDR + 0x04U)
#define TR_fileMgr_open_file TRAP(FileMgr_VT_ADDR + 0x08U)
#define TR_fileMgr_x0C TRAP(FileMgr_VT_ADDR + 0x0CU) /* RE sub_2A550 */
#define TR_fileMgr_x10 TRAP(FileMgr_VT_ADDR + 0x10U) /* RE sub_2A4E0 */
#define TR_fileMgr_x14 TRAP(FileMgr_VT_ADDR + 0x14U) /* RE sub_2A45C */
#define TR_fileMgr_x18 TRAP(FileMgr_VT_ADDR + 0x18U) /* RE sub_2A3F4 */
#define TR_fileMgr_x1C TRAP(FileMgr_VT_ADDR + 0x1CU) /* RE sub_2A344 */
#define TR_fileMgr_x20                                                         \
  TRAP(FileMgr_VT_ADDR + 0x20U) /* RE sub_2A7BC（00001b62 高频） */
#define TR_fileMgr_x24 TRAP(FileMgr_VT_ADDR + 0x24U) /* RE sub_2A2D0 */
#define TR_fileMgr_x28 TRAP(FileMgr_VT_ADDR + 0x28U) /* RE sub_29EA0 */
#define TR_fileMgr_x2C TRAP(FileMgr_VT_ADDR + 0x2CU) /* RE sub_29E7C */
#define TR_fileMgr_x30                                                         \
  TRAP(FileMgr_VT_ADDR + 0x30U) /* RE sub_29E40（旧称 enumFile） */
#define TR_fileMgr_x34 TRAP(FileMgr_VT_ADDR + 0x34U) /* RE sub_29E08 */
#define TR_fileMgr_x38 TRAP(FileMgr_VT_ADDR + 0x38U) /* RE sub_29E00 */
#define TR_file_close TRAP(FILE_VT_ADDR + 0x04U)     /* Release */
#define TR_file_read TRAP(FILE_VT_ADDR + 0x08U)
#define TR_file_seek TRAP(FILE_VT_ADDR + 0x20U)
#define TR_file_tell TRAP(FILE_VT_ADDR + 0x24U) /* Tell：返回当前读写位置 */
...
#define TR_media_AddRef TRAP(MEDIA_VT_ADDR + 0x00U)
#define TR_media_Release TRAP(MEDIA_VT_ADDR + 0x04U)
#define TR_media_x08 TRAP(MEDIA_VT_ADDR + 0x08U)
#define TR_media_x0C TRAP(MEDIA_VT_ADDR + 0x0CU)
#define TR_media_play TRAP(MEDIA_VT_ADDR + 0x10U)
#define TR_media_stop TRAP(MEDIA_VT_ADDR + 0x14U)
#define TR_media_x18 TRAP(MEDIA_VT_ADDR + 0x18U)
#define TR_media_x1C TRAP(MEDIA_VT_ADDR + 0x1CU)
#define TR_media_x20 TRAP(MEDIA_VT_ADDR + 0x20U)
#define TR_media_x24 TRAP(MEDIA_VT_ADDR + 0x24U)
#define TR_media_x28 TRAP(MEDIA_VT_ADDR + 0x28U)
#define TR_media_x2C TRAP(MEDIA_VT_ADDR + 0x2CU)
#define TR_media_x30 TRAP(MEDIA_VT_ADDR + 0x30U)
#define TR_media_x34 TRAP(MEDIA_VT_ADDR + 0x34U)
#define TR_media_x38 TRAP(MEDIA_VT_ADDR + 0x38U)
#define TR_media_x3C TRAP(MEDIA_VT_ADDR + 0x3CU)
#define TR_media_x40 TRAP(MEDIA_VT_ADDR + 0x40U)
#define TR_media_x44 TRAP(MEDIA_VT_ADDR + 0x44U)
#define TR_media_x48 TRAP(MEDIA_VT_ADDR + 0x48U)
#define TR_media_x4C TRAP(MEDIA_VT_ADDR + 0x4CU)
#define TR_media_x50 TRAP(MEDIA_VT_ADDR + 0x50U)
#define TR_media_x54 TRAP(MEDIA_VT_ADDR + 0x54U)
#define TR_media_x58 TRAP(MEDIA_VT_ADDR + 0x58U)
...
#define TR_setting_AddRef TRAP(SETTING_VT_ADDR + 0x00U)
#define TR_setting_Release TRAP(SETTING_VT_ADDR + 0x04U)
#define TR_setting_x08 TRAP(SETTING_VT_ADDR + 0x08U)
#define TR_setting_x0C TRAP(SETTING_VT_ADDR + 0x0CU)
#define TR_setting_x10 TRAP(SETTING_VT_ADDR + 0x10U)
#define TR_setting_x14 TRAP(SETTING_VT_ADDR + 0x14U)
#define TR_setting_x18 TRAP(SETTING_VT_ADDR + 0x18U)
#define TR_setting_x1C TRAP(SETTING_VT_ADDR + 0x1CU)
#define TR_setting_x20 TRAP(SETTING_VT_ADDR + 0x20U)
#define TR_setting_x24 TRAP(SETTING_VT_ADDR + 0x24U)
#define TR_setting_x28 TRAP(SETTING_VT_ADDR + 0x28U)
#define TR_setting_x2C TRAP(SETTING_VT_ADDR + 0x2CU)
#define TR_setting_x30 TRAP(SETTING_VT_ADDR + 0x30U)
#define TR_setting_x34 TRAP(SETTING_VT_ADDR + 0x34U)

/* 00000405.app：FS vtable 缺失槽 */
#define TR_fs_enum TRAP(FS_VT + 0x30U) /* FS_VT[0x30]：enumFile */

/* 00000405.app 新增 ROOT_TABLE_ADDR vtable trap（索引 23..45） */

/*
 * 实测修正：applet 00000440 实际跳转 0x8A0060，即 ROOT_TABLE_ADDR+0x60；
 * 原先写成 ROOT_TABLE_ADDR+0x28 导致该 case 永不命中（memset 落到 default 分支）。
 * 注意这一段的偏移与注释普遍对不上，其他条目待逐个用真实 applet 验证。
 */
#define TR_root_memset TRAP(ROOT_TABLE_ADDR + 0x60U)
/* +0x50 memcmp（RE zmaee_memcmp @0x363E8，tramp 桩 0xb9b50）；+0x5C memcpy
 * （RE zmaee_memcpy @0x36470，桩 0xb9b40）。00001b62 调用现场+返回值用法确认。
 */
#define TR_root_memcmp TRAP(ROOT_TABLE_ADDR + 0x50U)
#define TR_root_memcpy TRAP(ROOT_TABLE_ADDR + 0x5CU)
/* +0x90 strchr：调用现场 r1='r' + strb 写回，strchr 家族 */
#define TR_root_strchr TRAP(ROOT_TABLE_ADDR + 0x90U)
#define TR_root_str_assign TRAP(ROOT_TABLE_ADDR + 0x78U) /* str_assign(str_obj, cstr) */
#define TR_root_get_tick TRAP(ROOT_TABLE_ADDR + 0xD8U)   /* ROOT_TABLE_ADDR[0xD8] */
...
#define TR_root_srand TRAP(ROOT_TABLE_ADDR + 0x40U) /* srand(seed) */
#define TR_root_rand TRAP(ROOT_TABLE_ADDR + 0x44U)  /* rand() */
#define TR_root_sqrt TRAP(ROOT_TABLE_ADDR + 0x104U) /* (double)->double */
#define TR_root_cos TRAP(ROOT_TABLE_ADDR + 0x114U)  /* (double)->double */
#define TR_root_sin TRAP(ROOT_TABLE_ADDR + 0x118U)  /* (double)->double */
...
#define TR_root_atan TRAP(ROOT_TABLE_ADDR + 0x110U) /* 实测：atan(dy/dx) 求角度 */
#define TR_root_tan TRAP(ROOT_TABLE_ADDR + 0x11CU)  /* 已定案：tan（见 zm_root.c 注释） */
#define TR_root_x12C TRAP(ROOT_TABLE_ADDR + 0x12CU)
#define TR_root_x130 TRAP(ROOT_TABLE_ADDR + 0x130U)
#define TR_root_x140 TRAP(ROOT_TABLE_ADDR + 0x140U)
#define TR_root_create_cbk TRAP(ROOT_TABLE_ADDR + 0x154U)
#define TR_root_x16C TRAP(ROOT_TABLE_ADDR + 0x16CU)
...
#define TR_root_x68C TRAP(ROOT_TABLE_ADDR + 0x68CU)
...
#define TR_netmgr_release TRAP(NETMGR_VT_ADDR + 0x04U)
#define TR_netmgr_x1C TRAP(NETMGR_VT_ADDR + 0x1CU)
#define TR_tapi_release TRAP(TAPI_VT_ADDR + 0x04U)
#define TR_tapi_x2C TRAP(TAPI_VT_ADDR + 0x2CU)
#define TR_tapi_x40 TRAP(TAPI_VT_ADDR + 0x40U)
#define TR_dll_init TRAP(DLL_OBJ_VT_ADDR + 0x08U)
#define TR_dll_config TRAP(DLL_OBJ_VT_ADDR + 0x0CU)
#define TR_dll_entry TRAP(DLL_OBJ_VT_ADDR + 0x10U)
#define TR_cbk_default TRAP(CBK_OBJ_VT_ADDR + 0x08U)
 ...
 * 不在本表内，属其它对象/越界调用。 */
#define TR_display_AddRef TRAP(DISPLAY_VT_ADDR + 0x00U)
#define TR_display_Release TRAP(DISPLAY_VT_ADDR + 0x04U)
#define TR_display_GetMaxLayerCount TRAP(DISPLAY_VT_ADDR + 0x08U)
#define TR_display_CreateLayer TRAP(DISPLAY_VT_ADDR + 0x0CU)
#define TR_display_CreateLayerExt TRAP(DISPLAY_VT_ADDR + 0x10U)
#define TR_display_FreeLayer TRAP(DISPLAY_VT_ADDR + 0x14U)
#define TR_display_x18 TRAP(DISPLAY_VT_ADDR + 0x18U) /* 实测被调，功能未知 stub */
#define TR_display_GetLayerInfo TRAP(DISPLAY_VT_ADDR + 0x1CU)
#define TR_display_clear TRAP(DISPLAY_VT_ADDR + 0x20U) /* 实测：clear(color) */
#define TR_display_SetLayerPosition TRAP(DISPLAY_VT_ADDR + 0x24U)
#define TR_display_Update TRAP(DISPLAY_VT_ADDR + 0x28U)
#define TR_display_fillRectR                                                    \
  TRAP(DISPLAY_VT_ADDR + 0x2CU) /* 实测：fillRect(rect_ptr)，空实现疑似 invalidate \
                            */
#define TR_display_GetActiveLayer TRAP(DISPLAY_VT_ADDR + 0x30U)
#define TR_display_x34 TRAP(DISPLAY_VT_ADDR + 0x34U) /* 实测被调，功能未知 stub */
#define TR_display_UnlockScreen TRAP(DISPLAY_VT_ADDR + 0x38U)
#define TR_display_RegisterCustomFont TRAP(DISPLAY_VT_ADDR + 0x3CU)
#define TR_display_commit                                                      \
  TRAP(DISPLAY_VT_ADDR + 0x40U) /* 实测：commit 提交帧缓冲                  \
                            */
#define TR_display_GetFontWidth TRAP(DISPLAY_VT_ADDR + 0x44U)
#define TR_display_getWidth TRAP(DISPLAY_VT_ADDR + 0x48U) /* 实测：返回屏幕宽度 */
#define TR_display_measureChar                                                 \
  TRAP(DISPLAY_VT_ADDR + 0x4CU) /* 实测：measureChar(gfx, char_ptr, count,       \
                              width_out, sp[metrics]) */
#define TR_display_DrawText TRAP(DISPLAY_VT_ADDR + 0x50U) /* 实测吻合：drawText */
#define TR_display_SetTransColor TRAP(DISPLAY_VT_ADDR + 0x54U)
#define TR_display_SetOpacity TRAP(DISPLAY_VT_ADDR + 0x58U)
#define TR_display_SetClipRect TRAP(DISPLAY_VT_ADDR + 0x5CU)
#define TR_display_GetClipRect TRAP(DISPLAY_VT_ADDR + 0x60U)
#define TR_display_SetPixel TRAP(DISPLAY_VT_ADDR + 0x64U)
#define TR_display_DrawLine TRAP(DISPLAY_VT_ADDR + 0x68U)
#define TR_display_DrawRect TRAP(DISPLAY_VT_ADDR + 0x6CU) /* 实测吻合：drawRect */
#define TR_display_FillRect TRAP(DISPLAY_VT_ADDR + 0x70U) /* 实测吻合：fillRect */
#define TR_display_DrawRoundRect TRAP(DISPLAY_VT_ADDR + 0x74U)
#define TR_display_DrawCircle TRAP(DISPLAY_VT_ADDR + 0x78U)
#define TR_display_FillCircle TRAP(DISPLAY_VT_ADDR + 0x7CU)
#define TR_display_DrawArc TRAP(DISPLAY_VT_ADDR + 0x80U)
#define TR_display_FillArc TRAP(DISPLAY_VT_ADDR + 0x84U)
#define TR_display_FillGradientRect TRAP(DISPLAY_VT_ADDR + 0x88U)
#define TR_display_AlphaBlendRect TRAP(DISPLAY_VT_ADDR + 0x8CU)
#define TR_display_DrawImage TRAP(DISPLAY_VT_ADDR + 0x90U)
#define TR_display_DrawBitmap TRAP(DISPLAY_VT_ADDR + 0x94U)
#define TR_display_DrawBitmapEx TRAP(DISPLAY_VT_ADDR + 0x98U)
#define TR_display_DrawBitmapFrame TRAP(DISPLAY_VT_ADDR + 0x9CU)
#define TR_display_CreateBitmap                                                \
  TRAP(DISPLAY_VT_ADDR + 0xA0U)                             /* 返回 BITMAP 单例   \
                                                        */
#define TR_display_LoadBitmap TRAP(DISPLAY_VT_ADDR + 0xA4U) /* 返回 BITMAP 单例 */
#define TR_display_CreateImage TRAP(DISPLAY_VT_ADDR + 0xA8U)
#define TR_display_BitBlt TRAP(DISPLAY_VT_ADDR + 0xACU)
#define TR_display_Flatten TRAP(DISPLAY_VT_ADDR + 0xB0U)
#define TR_display_StretchBlt TRAP(DISPLAY_VT_ADDR + 0xB4U)
#define TR_display_DrawAntialiasingLine TRAP(DISPLAY_VT_ADDR + 0xB8U)
#define TR_display_DrawWLine TRAP(DISPLAY_VT_ADDR + 0xBCU)
#define TR_display_GetDMLayerHdlr TRAP(DISPLAY_VT_ADDR + 0xC0U)
#define TR_display_RelevanceLayer TRAP(DISPLAY_VT_ADDR + 0xC4U)
#define TR_display_Refresh TRAP(DISPLAY_VT_ADDR + 0xC8U)
#define TR_display_DrawImageExt TRAP(DISPLAY_VT_ADDR + 0xCCU)
#define TR_display_DrawSysWallPaper TRAP(DISPLAY_VT_ADDR + 0xD0U)
#define TR_display_DrawBorderText TRAP(DISPLAY_VT_ADDR + 0xD4U)
#define TR_display_PushAndSetAlphaLayer TRAP(DISPLAY_VT_ADDR + 0xD8U)
#define TR_display_PopAndRestoreAlphaLayer TRAP(DISPLAY_VT_ADDR + 0xDCU)
#define TR_display_RotateScreen TRAP(DISPLAY_VT_ADDR + 0xE0U)
...
#define TR_image_AddRef TRAP(IMAGE_VT_ADDR + 0x00U)
#define TR_image_Release TRAP(IMAGE_VT_ADDR + 0x04U)
#define TR_image_SetData TRAP(IMAGE_VT_ADDR + 0x08U)
#define TR_image_x0C TRAP(IMAGE_VT_ADDR + 0x0CU)
#define TR_image_x10 TRAP(IMAGE_VT_ADDR + 0x10U)
#define TR_image_x14 TRAP(IMAGE_VT_ADDR + 0x14U)
#define TR_image_Width TRAP(IMAGE_VT_ADDR + 0x18U)
#define TR_image_Decode TRAP(IMAGE_VT_ADDR + 0x1CU)
...
#define TR_surf_getrect                                                        \
  TRAP(SURF_VT + 0x10U) /* GetRect(this,out)：实测使用                    \
                         */
...
#define TR_image_x20 TRAP(IMAGE_VT_ADDR + 0x20U)
#define TR_image_x24 TRAP(IMAGE_VT_ADDR + 0x24U)
#define TR_image_x28 TRAP(IMAGE_VT_ADDR + 0x28U)
#define TR_image_x2C TRAP(IMAGE_VT_ADDR + 0x2CU)
#define TR_image_x30 TRAP(IMAGE_VT_ADDR + 0x30U)
#define TR_image_x34 TRAP(IMAGE_VT_ADDR + 0x34U)
#define TR_image_x38 TRAP(IMAGE_VT_ADDR + 0x38U)
#define TR_image_x3C TRAP(IMAGE_VT_ADDR + 0x3CU)

/* ---- ZMAEE IBitmap 原生虚表（g_aee_bitmap_vtbl @ .data:0x63DF4）----
 * +0x0C/0x14/0x18 是 sub_25F78/sub_25F84/sub_25FF8（未知），接 stub。 */
#define TR_bitmap_AddRef TRAP(BITMAP_VT_ADDR + 0x00U)
#define TR_bitmap_Release TRAP(BITMAP_VT_ADDR + 0x04U)
#define TR_bitmap_SetTransColor TRAP(BITMAP_VT_ADDR + 0x08U)
#define TR_bitmap_sub_25F78 TRAP(BITMAP_VT_ADDR + 0x0CU)
#define TR_bitmap_GetInfo TRAP(BITMAP_VT_ADDR + 0x10U)
#define TR_bitmap_sub_25F84 TRAP(BITMAP_VT_ADDR + 0x14U)
#define TR_bitmap_sub_25FF8 TRAP(BITMAP_VT_ADDR + 0x18U)

//
#define TR_init_callback                                                       \
  TRAP(ROOT_TABLE_ADDR + 0x118cU) // 随便写一个位置我想也应该不影响这个叫什么来.初始化回调

// 事件回调因为 apple 是没有主循环的所以要用外部来完成这个主循环
#define TR_enter_event_loop TRAP(ROOT_TABLE_ADDR + 0x1180U)

/* TR_init_callback 执行期间，applet 会调用 ROOT_TABLE_ADDR+0x1184 把事件循环的入口
 ...
 * 直接退出（PC 飞出 blob）。 */
#define TR_register_event_loop TRAP(ROOT_TABLE_ADDR + 0x1184U)

/* applet 通过它向宿主请求退出（实测 00000506 参数字符串为 "aborted"）。 */
#define TR_abort TRAP(ROOT_TABLE_ADDR + 0x0014U)
