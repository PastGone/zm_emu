...
_Static_assert(offsetof(AppletHeader, Reserved_0x054) == 0x054,
               "Reserved_0x054 偏移错误");
_Static_assert(offsetof(AppletHeader, ProgramUID) == 0x074,
               "ProgramUID 偏移错误");
_Static_assert(offsetof(AppletHeader, ActivationType) == 0x084,
               "ActivationType 偏移错误");
_Static_assert(offsetof(AppletHeader, ActivationKey) == 0x088,
               "ActivationKey 偏移错误");
_Static_assert(offsetof(AppletHeader, UnknownDataLength) == 0x098,
               "UnknownDataLength 偏移错误");
_Static_assert(offsetof(AppletHeader, UnknownData) == 0x09C,
               "UnknownData 偏移错误");
_Static_assert(offsetof(AppletHeader, MinScreenWidth) == 0x174,
               "MinScreenWidth 偏移错误");
_Static_assert(offsetof(AppletHeader, MinScreenHeight) == 0x178,
               "MinScreenHeight 偏移错误");
_Static_assert(offsetof(AppletHeader, MaxScreenWidth) == 0x17C,
               "MaxScreenWidth 偏移错误");
_Static_assert(offsetof(AppletHeader, MaxScreenHeight) == 0x180,
               "MaxScreenHeight 偏移错误");
_Static_assert(offsetof(AppletHeader, Unknown_0x184) == 0x184,
               "Unknown_0x184 偏移错误");
